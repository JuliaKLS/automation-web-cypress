...
describe('Cadastros de Funcionarios - WEB', () => {
  it('Cadastrar Funcionario Com Sucesso', () => {
    ...
    cy.verificaMensagemSucesso();
  });
});



describe ('Cadastrar Funcionario - Responsivo', () => {
  beforeEach(() => {
    cy.viewport('iphone-x'); // ou cy.viewport(375, 812)
  });

  it.only('Cadastrar Funcionario Com Sucesso no iphone-x', () => {
    cy.login();
